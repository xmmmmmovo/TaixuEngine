...
public:
    ...
    constexpr friend bool operator==(const Color& lhs, const Color& rhs) { return lhs._value == rhs._value; }
    ...
    [[nodiscard]] constexpr ImVec4 toImVec4() const { return {_value.x, _value.y, _value.z, _value.w}; }
