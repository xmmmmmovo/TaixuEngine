...
namespace literals {
    NODISCARD TX_INLINE tx_string operator""_txs(const char* str, size_t len) { return tx_string{str, len}; }

    NODISCARD TX_INLINE tx_wstring operator""_txws(const wchar_t* str, size_t len) { return tx_wstring{str, len}; }
