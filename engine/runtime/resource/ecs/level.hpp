...
void initialize(){
    ...
    GameObject sphere;
    sphere.set_id(GUID_Generator::generate_new_guid());
    GOs.push_back(sphere);

    GameObject another_sphere;
    another_sphere.set_id(GUID_Generator::generate_new_guid());
    GOs.push_back(another_sphere);
    };
