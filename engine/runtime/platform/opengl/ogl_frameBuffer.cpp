...
void OGLFrameBuffer::allocate(glm::vec2 frame_size) {
    ...
    glRenderbufferStorage(
            GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, frame_size.x,
            frame_size
                    .y);// use a single renderbuffer object for both a depth AND stencil buffer.
...
void OGLFrameBuffer::bind() { glBindFramebuffer(GL_FRAMEBUFFER, bufferTexId); }
