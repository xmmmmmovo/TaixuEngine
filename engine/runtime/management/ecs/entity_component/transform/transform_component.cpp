...
void      TransformComponent::makeTransformMatrix() {
    ...
    glm::quat rotateX = glm::angleAxis(glm::radians(rotation_degrees.x),
                                            glm::vec3(1.0f, 0.0f, 0.0f));
    glm::quat rotateY = glm::angleAxis(glm::radians(rotation_degrees.y),
                                            glm::vec3(0.0f, 1.0f, 0.0f));
    glm::quat rotateZ = glm::angleAxis(glm::radians(rotation_degrees.z),
